        ...
        <View>
            <View className="relative w-full">
                <TextInput
                    ...
                    className={`w-full pl-4 pr-12 py-3 rounded-xl bg-zinc-50 dark:bg-zinc-800/50  border border-zinc-200 dark:border-zinc-700 
                    focus:outline-none focus:ring-2  text-zinc-900 dark:text-zinc-100  placeholder:text-zinc-400 dark:placeholder:text-zinc-500
                    ${passwordErrorText ? "focus:ring-rose-500 invalid:focus:border-rose-600" :  "focus:ring-orange-500/50 focus:border-orange-500"}`}
                />
...
export function EmailInputCustom({ value, onChangeText, setIsEmailValid, customError = "" }) {
    ...
    return (
        <View className="relative w-full flex flex-col gap-2">
            <TextInput
                placeholder="Email"
                ...
                focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 invalid:border-rose-600 invalid:focus:ring-rose-500/50
                invalid:focus:border-rose-600 text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500"/>
