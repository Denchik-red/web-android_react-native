        ...
        flex flex-col p-8 md:p-12 relative z-10 items-center">
            <View
                ...
                <Pressable
                    ...
                    className="w-full ios:w-84 py-3 px-4 rounded-xl ios:bg-orange-600 web:bg-linear-to-r web:from-orange-600 web:to-orange-700 text-white font-semibold text-lg shadow-lg shadow-orange-500/30
                ...
                <Text onPress={() => {setAuthStatus("register")}} className="text-center text-zinc-600 dark:text-zinc-400">
                    Ещё нет аккаунта?
                </Text>
            </View>
        </View>
